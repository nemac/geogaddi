...
//            props = GeogaddiOptionsFactory.createPropertyManager(managerType, propertiesSource).build();
//
...
//            boolean derive = props.isDeriverEnabled() && cmd.hasOption("j"); // currently only implemented for JSON_PROPS-based properties
//
...
//                for (TransformationOptions transformation : props.getTransformations()) {
